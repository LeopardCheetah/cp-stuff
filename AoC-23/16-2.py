...
# ok let's loop through all possible queue values

possible_lavas = []
starting_pairs = [(_, 0, 'R') for _ in range(110)] + [(0, _, 'D') for _ in range(110)] + [(109, _, 'U') for _ in range(110)] + [(_, 109, 'L') for _ in range(110)]


for some_pair in starting_pairs:
    ...
    possible_lavas.append(total_sum)

print(max(possible_lavas))
